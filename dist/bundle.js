...
function fetchQuestion() {
  ...
  return function (dispatch) {
    fetch('https://opentdb.com/api.php?amount=1&type=multiple').then(function (response) {
...
function receiveQuestion(question) {
  ...
  question.answersArray = shuffle([].concat(_toConsumableArray(question.incorrect_answers), [question.correct_answer]));
  return {
...
function shuffle(answers) {
  return answers.map(function (a) {
    return { key: Math.random(), value: a };
  }).sort(function (a, b) {
    return a.key - b.key;
  }).map(function (a) {
    return a.value;
...
function receiveAnswer(answer, question) {
  var answerType = answer === question.correct_answer ? 'CORRECT_ANSWER' : 'INCORRECT_ANSWER';
  return {
    type: answerType,
    answer: answer,
    question: question
...
var _ScoreContainer = __webpack_require__(/*! ../containers/ScoreContainer */ "./src/containers/ScoreContainer.js");

var _ScoreContainer2 = _interopRequireDefault(_ScoreContainer);

var _NextContainer = __webpack_require__(/*! ../containers/NextContainer */ "./src/containers/NextContainer.js");
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_ScoreContainer2.default, null),
        _react2.default.createElement(_NextContainer2.default, null)
      );
    }
  }]);
...
function Next(_ref) {
    var currentQuestion = _ref.currentQuestion,
        ...
        fetchQuestion = _ref.fetchQuestion;
...
var Question = function (_React$Component) {
    ...
    _createClass(Question, [{
        ...
        value: function render() {
            ...
            var questionObject = this.props.question;
            return !!questionObject && _react2.default.createElement(
                "article",
                null,
                _react2.default.createElement(
                    "div",
                    null,
                    "Question: ",
                    (0, _he.decode)(questionObject.question)
                ),
                _react2.default.createElement(
                    "ul",
                    { className: "answers" },
                    "Answers: ",
                    questionObject.answersArray.map(function (answer) {
                        return _react2.default.createElement(
                            "li",
                            {
                                ...
                                onClick: function onClick(event) {
                                    event.preventDefault();
                                    _this2.props.receiveAnswer(answer, questionObject);
                                }
                            },
                            (0, _he.decode)(answer)
                        );
...
/***/ "./src/containers/NextContainer.js":
/*!*****************************************!*\
  !*** ./src/containers/NextContainer.js ***!
  \*****************************************/
/*! no static exports found */
...
var _Next = __webpack_require__(/*! ../components/Next */ "./src/components/Next.js");
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        nextQuestion: function nextQuestion() {
            return dispatch((0, _actions.nextQuestion)());
        },
        fetchQuestion: function fetchQuestion() {
            return dispatch((0, _actions.fetchQuestion)());
        }
    };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_Next2.default);
...
var _Question = __webpack_require__(/*! ../components/Question */ "./src/components/Question.js");
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    ...
    return {
        ...
        receiveAnswer: function receiveAnswer(answer, question) {
            return dispatch((0, _actions.receiveAnswer)(answer, question));
        }
    };
};
...
/***/ "./src/containers/ScoreContainer.js":
/*!******************************************!*\
  !*** ./src/containers/ScoreContainer.js ***!
  \******************************************/
/*! no static exports found */
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(_Score2.default);
...
var _question = __webpack_require__(/*! ./question */ "./src/reducers/question.js");
...
var _next = __webpack_require__(/*! ./next */ "./src/reducers/next.js");
...
function score() {
    ...
    var correct = action.type === 'CORRECT_ANSWER' ? 'YES' : 'NO';
    var question = !!action.question ? action.question.question : null;
    var result = [].concat(_toConsumableArray(state.result), [{ question: question, answer: action.answer, correct: correct }]);
    switch (action.type) {
        case 'CORRECT_ANSWER':
            return {
